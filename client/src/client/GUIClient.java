...
public class GUIClient extends javax.swing.JFrame {
    ...
    public GUIClient(String host, int port, String nameRoom, String username) {
        initComponents();
        ...
        defaultRoom = nameRoom;
        tfPort.setText("" + defaultPort);
        tfServer.setText(defaultHost);
        userName.setText(defaultUsername);
        room.setText(defaultRoom);
    ...
    private void initComponents() {
        ...
        room.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        room.setForeground(new java.awt.Color(255, 255, 255));
        room.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        room.setToolTipText("message");
        room.setAlignmentX(0.0F);
        room.setAlignmentY(0.0F);
        room.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(102, 255, 204)));
        room.setEnabled(false);
        room.setOpaque(false);
        room.setPreferredSize(new java.awt.Dimension(0, 25));

        label2.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        label2.setForeground(new java.awt.Color(102, 255, 204));
            ...
            .addGroup(InputPanelLayout.createSequentialGroup()
                ...
                .addGroup(InputPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(InputPanelLayout.createSequentialGroup()
                        .addComponent(label)
                        .addGap(4, 4, 4)
                        .addComponent(room, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
